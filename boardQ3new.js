[[jsxgraph input-ref-ansA='ansAref' input-ref-ansB='ansBref' input-ref-ansC='ansCref' width="800px" height="800px"]]
...
var x1={#x1#},x2={#x2#},x3={#x3#},fixed={#fixed#};
var answered=false;
...
var mmin=Math.min(x1[0],x1[1],x2[0],x2[1],x3[0],x3[1]);
var mmax=Math.max(x1[0],x1[1],x2[0],x2[1],x3[0],x3[1]);
...
if (fixed==1) {x2[1]=x2[0]; x3[1]=x3[0]}
else if (fixed==2) {x1[1]=x1[0]; x3[1]=x3[0]}
else {x1[1]=x1[0]; x2[1]=x2[0]};
